    ...
    await queryInterface.bulkInsert("Vendors", [
      {
        ...
        path: "Tantalizer",
        name: "Tantalizer",
        imageId: "flashio/images/restaurants/Tantalizer",
        location: "Ajebandele",
      ...
      },
      {
        ...
        path: "Mr-Biggs",
        name: "Mr Biggs",
        imageId: "flashio/images/restaurants/Mr-Biggs",
        location: "New era",
      ...
      },
      {
        ...
        path: "Crunchy",
        name: "Crunchy",
        imageId: "flashio/images/restaurants/Crunchy",
        location: "Mayfair",
      ...
      },
      {
        ...
        path: "Captain-cook",
        name: "Captain Cook",
        imageId: "flashio/images/restaurants/Captain-cook",
        location: "Mayfair",
        deliveryTime: "20-35 mins",
        deliveryFee: 450,
        description: "Classic Nigerian fast food chain.",
      ...
      },
      {
        ...
        path: "ivory_bite",
        name: "Ivory Bite",
        imageId: "flashio/images/restaurants/Ivory-bite",
